...
test("renders current profession retirement benchmarks", async () => {
  const cases = [
    ["/profesi/guru", /BUP Guru ASN 60 tahun/, /2063/],
    ["/profesi/polisi", /BUP Bintara\/Tamtama Polri 59 tahun/, /2066/],
    ["/profesi/tni", /BUP Bintara\/Tamtama TNI 55 tahun/, /2062/],
  ];

  for (const [path, rule, year] of cases) {
